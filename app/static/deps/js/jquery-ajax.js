...
$(document).ready(function () {
    // Скрипт описывающий добавление товаров в корзину
    ...
    // Скрипт описывающий удаление товаров из корзины
    ...
    function updateCart(cartID, amount, change, url) {
        $.ajax({
            type: "POST",
            url: url,
            data: {
